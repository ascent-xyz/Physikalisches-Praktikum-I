...
\DeclarePairedDelimiterXPP\Exp[1]{\operatorname{exp}}{(}{)}{}{#1} %exp Operator mit passendem Klammern Spacing oder so – Mit \Exp*{} wird automatische Klammerskalierung aktiviert!!!
